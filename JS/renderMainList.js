    ...
    arr.map((task) => {
        ...
        <li class="btn">
            <button id=${task.id} class="button__active__list button__edit">
                <img id=${task.id} class="img__logo" src="../img/editMod.png" alt="edit" value=edit title="Edit">
            </button>
            <button id=${task.id} class="button__active__list button__delete">
                <img id=${task.id} class="img__logo" src="./img/garbageMod.png" alt="delete" value=delete title="Delete"> 
            </button>
            <button id=${task.id} class="button__active__list button__arh">
                <img id=${task.id} class="img__logo img__main" src="./img/arhMod.png" alt="arhive" value=arhive title="Remove to arhive">   
            </button>                          
        </li>    
        `;
