...
function renderCurrentToDoLost() {
    ...
    arr.map((task) => {
        ...
        <div class="btn">
            <button id=${task.id} class="button-active-list button-edit">               
            </button>
            <button id=${task.id} class="button-active-list button-delete" value= delete_main>   
            </button>
        <button id=${task.id} class="button-active-list button-arh" value=archive_main>           
            </button>                          
        </div>    
        `;
